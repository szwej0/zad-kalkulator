...
class kustra88ConvertcController extends Controller
{
    /**
     * @Route("/kustra88/convertc/show/form", name="kustra88_convertc_show_form")
     */
    ...
    /**
     * @Route("/kustra88/convertc/przetworz", name="kustra88_convertc_wynik")
     * @Method("POST")
     */
    ...
    private function createCreateForm(Convert $convert)
    {
        $form = $this->createForm(new kustra88ConvertType(), $convert, array(
            'action' => $this->generateUrl('kustra88_convertc_wynik'),
            'method' => 'POST',
        ));
